                        ...
                        <div class="card-body">
                                    ...
                                    <div class="card h-100 border shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                  <div class="pedido-values-container">                                                    <small class="text-muted pedido-values-label">Valores</small>                                                    
                                                    <div class="row g-2 align-items-center">                                                        
                                                    <div class="col-6">                                                            
                                                    <div class="bg-light p-2 text-center border" style="border-radius: 10px 10px 10px 10px !important">
                                                                <span class="text-muted small">Produtos</span><br>
                                                                <span class="fw-bold fs-5">R$ ${pedido.valor_total}</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="bg-primary bg-opacity-10 p-2 text-center border border-start-0" style="border-radius: 10px 10px 10px 10px !important">
                            ...
                            <div class="card border mt-4">
                                <div class="card-body">
                                    ...
                                    <div class="list-group">                                        ${pedido.historico_status.map(status => `
                                            <div class="list-group-item list-group-item-action">
                                                <div class="d-flex w-100 justify-content-between align-items-center">
                                                    <div>
                                                        ...
                                                        ${status.comentario ? `
                                                        <p class="mb-0 mt-1 text-muted" style="font-size: 0.9em;">
